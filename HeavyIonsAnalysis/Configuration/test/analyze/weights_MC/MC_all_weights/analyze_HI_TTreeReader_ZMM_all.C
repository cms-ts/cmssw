...
void analyze_HI_TTreeReader_ZMM_all(bool isPbPb = true) {
  ...
  if (isPbPb) {
    ...
    file_output_HI_mu = new TFile("./output_ppref_mu_MC_all.root", "RECREATE");
  }
