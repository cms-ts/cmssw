...
#include "TLatex.h"
#include "TGraph.h"
#include "../MC_samples_ppref.h" // Include the header file
#include "tdrstyle.C"
#include "mycolor.h"
...
void h_stack_ppref() {
    ...
    for (const auto& histo : histo_par) {
        ...
        for (const auto& file : files) {
            ...
            TDirectoryFile* dir = (TDirectoryFile*)file_->Get("pp/Muons");
        ...
        // Get data histogram
        TFile* file_data = TFile::Open("./output_ppref_mu_data.root", "READ");
        TDirectoryFile* dir_data = (TDirectoryFile*)file_data->Get("pp/Muons");
        ...
        if (histo_name == "h_deltaPhi_Zj" || histo_name == "h_jet_deltaR" || histo_name == "h_antimu_eta" ||
            ...
            histo_name == "h_mu_eta" || histo_name == "h_mu_phi") h_data->SetMaximum(200*y_max);
        else  h_data->SetMaximum(20.*y_max);
