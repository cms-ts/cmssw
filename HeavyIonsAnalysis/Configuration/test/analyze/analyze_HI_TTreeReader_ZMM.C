...
void analyze_HI_TTreeReader_ZMM(bool isData = true) {
  ...
  cout << "This is data" << endl;
    ...
    glob("/eos/infnts/cms/store/user/kdeleo/DYto2Mu_MLL-50_TuneCP5_5p36TeV_powheg-pythia8/CRAB3_Analysis_test12_noGen_Zmumu_DYto2Mu/250211_113041/0000/HiForestMiniAOD_MC_*.root", GLOB_NOSORT, NULL, &globlist);
