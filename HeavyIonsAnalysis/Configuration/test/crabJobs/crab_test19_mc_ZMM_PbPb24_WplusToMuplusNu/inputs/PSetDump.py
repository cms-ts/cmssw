...
process.ak2PFUnsubJetFlavourInfos = cms.EDProducer("JetFlavourClustering",
...
process.akCs2PFJets = cms.EDProducer("CSJetProducer",
    ...
    rhoFlowFitParams = cms.InputTag("rhoModulationAkCs2PFJets","rhoFlowFitParams"),
...
process.patJetCorrFactorsAK2PFBtag = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
    ...
    src = cms.InputTag("patJetsAKCs2PF"),
...
process.patJetCorrFactorsAKCs2PF = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
    extraJPTOffset = cms.string('L1FastJet'),
    flavorType = cms.string('J'),
    levels = cms.vstring(
...
process.patJetFlavourAssociationAKCs2PF = cms.EDProducer("JetFlavourClustering",
...
process.patJetFlavourAssociationLegacyAKCs2PF = cms.EDProducer("JetFlavourIdentifier",
    physicsDefinition = cms.bool(False),
    srcByReference = cms.InputTag("patJetPartonAssociationLegacyAKCs2PF")
)
...
process.patJetGenJetMatchAKCs2PF = cms.EDProducer("GenJetMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("ak2GenJetsReclusterNoNu"),
    maxDeltaR = cms.double(0.2),
    mcPdgId = cms.vint32(),
...
process.patJetPartonAssociationLegacyAKCs2PF = cms.EDProducer("JetPartonMatcher",
    coneSizeToAssociate = cms.double(0.3),
    jets = cms.InputTag("akCs2PFJets"),
    partons = cms.InputTag("allPartons")
)
...
process.patJetPartonMatchAKCs2PF = cms.EDProducer("MCMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("hiSignalGenParticles"),
    maxDPtRel = cms.double(3.0),
    maxDeltaR = cms.double(0.4),
...
process.patJetsAKCs2PF = cms.EDProducer("PATJetProducer",
    JetFlavourInfoSource = cms.InputTag("patJetFlavourAssociationAKCs2PF"),
    JetPartonMapSource = cms.InputTag("patJetFlavourAssociationLegacyAKCs2PF"),
    addAssociatedTracks = cms.bool(False),
    addBTagInfo = cms.bool(False),
    addDiscriminators = cms.bool(False),
    addEfficiencies = cms.bool(False),
    ...
    genJetMatch = cms.InputTag("patJetGenJetMatchAKCs2PF"),
    genPartonMatch = cms.InputTag("patJetPartonMatchAKCs2PF"),
    getJetMCFlavour = cms.bool(True),
    jetChargeSource = cms.InputTag(""),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsAKCs2PF")),
    jetIDMap = cms.InputTag("ak4JetID"),
...
process.pfJetProbabilityBJetTagsAK2PFBtag = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetProbabilityComputer'),
    tagInfos = cms.VInputTag("pfImpactParameterTagInfosAK2PFBtag")
)
...
process.siPixelRecHitsPreSplittingAlpaka = cms.EDProducer("SiPixelRecHitAlpakaHIonPhase1@alpaka",
...
process.siPixelRecHitsPreSplittingAlpakaSerial = cms.EDProducer("alpaka_serial_sync::SiPixelRecHitAlpakaHIonPhase1",
    CPE = cms.string('PixelCPEFastParamsHIonPhase1'),
    beamSpot = cms.InputTag("offlineBeamSpotDevice"),
    mightGet = cms.optional.untracked.vstring,
...
process.unsubAK2JetMap = cms.EDProducer("JetMatcherDR",
    ...
    source = cms.InputTag("selectedUpdatedPatJetsAK2PF")
)


process.unsubUpdatedPatJetsAK2PF = cms.EDProducer("JetMatcherDR",
    matched = cms.InputTag("patJetsAK2PFUnsubJets"),
    source = cms.InputTag("updatedPatJetsAK2PFBtag")
)


process.updatedPatJetsAK2PFBtag = cms.EDProducer("PATJetUpdater",
    addBTagInfo = cms.bool(False),
    addDiscriminators = cms.bool(True),
    addJetCorrFactors = cms.bool(True),
    addTagInfos = cms.bool(False),
    discriminatorSources = cms.VInputTag(),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsAK2PFBtag")),
    jetSource = cms.InputTag("patJetsAKCs2PF"),
    mightGet = cms.optional.untracked.vstring,
...
process.hltfilter = cms.EDFilter("HLTHighLevel",
    HLTPaths = cms.vstring('HLT_HIL2SingleMu7_v7'),
...
process.selectedPatJetsAKCs2PF = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    cutLoose = cms.string(''),
    nLoose = cms.uint32(0),
    src = cms.InputTag("patJetsAKCs2PF")
...
process.selectedUpdatedPatJetsAK2PFBtag = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    cutLoose = cms.string(''),
    nLoose = cms.uint32(0),
    src = cms.InputTag("updatedPatJetsAK2PFBtag")
)


process.HiForestInfo = cms.EDAnalyzer("HiForestInfo",
    GlobalTagLabel = cms.string('141X_mcRun3_2024_realistic_HI_v11'),
    HiForestVersion = cms.string(''),
    info = cms.vstring('HiForest, miniAOD, 140X, mc')
)
...
process.akCs2PFJetAnalyzer = cms.EDAnalyzer("HiInclusiveJetAnalyzer",
    ...
    jetFlavourInfos = cms.InputTag("ak2PFUnsubJetFlavourInfos"),
    jetName = cms.untracked.string('akCs2PF'),
    jetPtMin = cms.double(15),
    jetTag = cms.InputTag("selectedUpdatedPatJetsAK2PFBtag"),
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('141X_mcRun3_2024_realistic_HI_v11'),
...
process.genTask = cms.Task(process.ak2GenJetsReclusterNoNu, process.ak2PFUnsubJetFlavourInfos, process.allPartons, process.hiSignalGenParticles, process.packedGenParticlesForJetsNoNu, process.selectedHadronsAndPartons)
...
process.patAlgosToolsTask = cms.Task(process.PackedPFTowers, process.ak2PFUnsubJets, process.akCs2PFJets, process.hiPuRho, process.patJetCorrFactorsAK2PFBtag, process.patJetCorrFactorsAK2PFUnsubJets, process.patJetCorrFactorsAKCs2PF, process.patJetFlavourAssociationAK2PFUnsubJets, process.patJetFlavourAssociationAKCs2PF, process.patJetFlavourAssociationLegacyAK2PFUnsubJets, process.patJetFlavourAssociationLegacyAKCs2PF, process.patJetGenJetMatchAK2PFUnsubJets, process.patJetGenJetMatchAKCs2PF, process.patJetPartonAssociationLegacyAK2PFUnsubJets, process.patJetPartonAssociationLegacyAKCs2PF, process.patJetPartonMatchAK2PFUnsubJets, process.patJetPartonMatchAKCs2PF, process.patJetPartons, process.patJetPartonsLegacy, process.patJetPartonsLegacyUnsubJets, process.patJetPartonsUnsubJets, process.patJetsAK2PFUnsubJets, process.patJetsAKCs2PF, process.selectedPatJetsAK2PFUnsubJets, process.selectedPatJetsAKCs2PF, process.selectedUpdatedPatJetsAK2PFBtag, process.unsubAK2JetMap, process.unsubUpdatedPatJetsAK2PF, process.updatedPatJetsAK2PFBtag)
...
process.zdcSequencePbPb = cms.Sequence(process.zdcrecoRun3+process.zdcanalyzer)


process.zMMSkimSequence = cms.Sequence(process.hltfilter+process.primaryVertexFilterForZMM+process.muonSelectorForZMM+process.muonFilterForZMM+process.dimuonMassCutForZMM+process.dimuonMassCutFilterForZMM)


process.forest = cms.Path(process.zMMSkimSequence+process.HiForestInfo+process.centralityBin+process.hltanalysis+process.trackSequencePbPb+process.hiEvtAnalyzer+process.HiGenParticleAna+process.rhoSequence+process.metFilters+process.unpackedMuons+process.muonAnalyzer+process.akCs2PFJetAnalyzer, process.genTask, process.patAlgosToolsTask)


process.pclusterCompatibilityFilter = cms.Path(process.zMMSkimSequence+process.clusterCompatibilityFilter)


process.pprimaryVertexFilter = cms.Path(process.zMMSkimSequence+process.primaryVertexFilter)


process.pphfCoincFilter1Th3 = cms.Path(process.zMMSkimSequence+process.phfCoincFilter1Th3)


process.pphfCoincFilter1Th4 = cms.Path(process.zMMSkimSequence+process.phfCoincFilter1Th4)


process.pphfCoincFilter1Th5 = cms.Path(process.zMMSkimSequence+process.phfCoincFilter1Th5)


process.pphfCoincFilter2Th3 = cms.Path(process.zMMSkimSequence+process.phfCoincFilter2Th3)


process.pphfCoincFilter2Th4 = cms.Path(process.zMMSkimSequence+process.phfCoincFilter2Th4)


process.pphfCoincFilter2Th5 = cms.Path(process.zMMSkimSequence+process.phfCoincFilter2Th5)


process.pphfCoincFilter3Th3 = cms.Path(process.zMMSkimSequence+process.phfCoincFilter3Th3)


process.pphfCoincFilter3Th4 = cms.Path(process.zMMSkimSequence+process.phfCoincFilter3Th4)


process.pphfCoincFilter3Th5 = cms.Path(process.zMMSkimSequence+process.phfCoincFilter3Th5)


process.pphfCoincFilter4Th2 = cms.Path(process.zMMSkimSequence+process.phfCoincFilter4Th2)


process.pphfCoincFilter4Th3 = cms.Path(process.zMMSkimSequence+process.phfCoincFilter4Th3)


process.pphfCoincFilter4Th4 = cms.Path(process.zMMSkimSequence+process.phfCoincFilter4Th4)


process.pphfCoincFilter4Th5 = cms.Path(process.zMMSkimSequence+process.phfCoincFilter4Th5)


process.pphfCoincFilter5Th3 = cms.Path(process.zMMSkimSequence+process.phfCoincFilter5Th3)


process.pphfCoincFilter5Th4 = cms.Path(process.zMMSkimSequence+process.phfCoincFilter5Th4)


process.pphfCoincFilter5Th5 = cms.Path(process.zMMSkimSequence+process.phfCoincFilter5Th5)


process.pphfCoincFilterPF1Th10 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF1Th10)


process.pphfCoincFilterPF1Th3 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF1Th3)


process.pphfCoincFilterPF1Th4 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF1Th4)


process.pphfCoincFilterPF1Th5 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF1Th5)


process.pphfCoincFilterPF1Th6 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF1Th6)


process.pphfCoincFilterPF1Th7 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF1Th7)


process.pphfCoincFilterPF1Th8 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF1Th8)


process.pphfCoincFilterPF1Th9 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF1Th9)


process.pphfCoincFilterPF2Th10 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF2Th10)


process.pphfCoincFilterPF2Th3 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF2Th3)


process.pphfCoincFilterPF2Th4 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF2Th4)


process.pphfCoincFilterPF2Th5 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF2Th5)


process.pphfCoincFilterPF2Th6 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF2Th6)


process.pphfCoincFilterPF2Th7 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF2Th7)


process.pphfCoincFilterPF2Th8 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF2Th8)


process.pphfCoincFilterPF2Th9 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF2Th9)


process.pphfCoincFilterPF3Th10 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF3Th10)


process.pphfCoincFilterPF3Th3 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF3Th3)


process.pphfCoincFilterPF3Th4 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF3Th4)


process.pphfCoincFilterPF3Th5 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF3Th5)


process.pphfCoincFilterPF3Th6 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF3Th6)


process.pphfCoincFilterPF3Th7 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF3Th7)


process.pphfCoincFilterPF3Th8 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF3Th8)


process.pphfCoincFilterPF3Th9 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF3Th9)


process.pphfCoincFilterPF4Th10 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF4Th10)


process.pphfCoincFilterPF4Th2 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF4Th2)


process.pphfCoincFilterPF4Th3 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF4Th3)


process.pphfCoincFilterPF4Th4 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF4Th4)


process.pphfCoincFilterPF4Th5 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF4Th5)


process.pphfCoincFilterPF4Th6 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF4Th6)


process.pphfCoincFilterPF4Th7 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF4Th7)


process.pphfCoincFilterPF4Th8 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF4Th8)


process.pphfCoincFilterPF4Th9 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF4Th9)


process.pphfCoincFilterPF5Th10 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF5Th10)


process.pphfCoincFilterPF5Th3 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF5Th3)


process.pphfCoincFilterPF5Th4 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF5Th4)


process.pphfCoincFilterPF5Th5 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF5Th5)


process.pphfCoincFilterPF5Th6 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF5Th6)


process.pphfCoincFilterPF5Th7 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF5Th7)


process.pphfCoincFilterPF5Th8 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF5Th8)


process.pphfCoincFilterPF5Th9 = cms.Path(process.zMMSkimSequence+process.phfCoincFilterPF5Th9)
