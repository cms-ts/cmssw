...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        #'/store/data/Run2024J/PPRefSingleMuon0/MINIAOD/PromptReco-v1/000/387/396/00000/039176f9-70ce-47e0-8271-688bb8f0f5fd.root' #ok
        #'/store/data/Run2024J/PPRefSingleMuon3/MINIAOD/PromptReco-v1/000/387/396/00000/1b0b5c02-5a86-405d-8241-6b89928d3420.root' #ok
        '/store/data/Run2024J/PPRefSingleMuon3/MINIAOD/PromptReco-v1/000/387/506/00000/f5965c7b-0a25-4d33-b44f-85a4336bb9cd.root' #error
        #'/store/data/Run2024J/PPRefSingleMuon3/MINIAOD/PromptReco-v1/000/387/515/00000/85bf055a-adcf-4319-b295-5b44ed1f36e4.root' #error
    )
)

#import FWCore.PythonUtilities.LumiList as LumiList
#process.source.lumisToProcess = LumiList.LumiList(filename = 'Cert_Collisions2024_ppref_387474_387721_golden.json').getVLuminosityBlockRange()
...
process.noscraping = cms.EDFilter("FilterOutScraping",
    ...
    src =  cms.untracked.InputTag("unpackedTracksAndVertices") # generalTracks collection not found for all input files
)

process.goodvertex = cms.Path(process.primaryVertexFilter+process.noscraping)
#process.goodvertex = cms.Path(process.primaryVertexFilter)
...
process.hltfilter = hltHighLevel.clone(
    HLTPaths = ["HLT_PPRefL2SingleMu7_v6"
    ]
)
...
process.skimanalysis.superFilters = cms.vstring("zMMSkimPath")
