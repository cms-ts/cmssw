...
config.General.requestName = 'test12_mc_noGen_Zmumu_DYto2Mu'

config.JobType.pluginName = 'Analysis'
# Name of the CMSSW configuration file
config.JobType.psetName = 'forest_miniAOD_run3_MC_Zmumu_noGen.py'
...
config.Data.outputDatasetTag = 'CRAB3_Analysis_test12_noGen_Zmumu_DYto2Mu'
