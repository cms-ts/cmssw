...
process.ak3PFUnsubJetFlavourInfos = cms.EDProducer("JetFlavourClustering",
    bHadrons = cms.InputTag("selectedHadronsAndPartons","bHadrons"),
    cHadrons = cms.InputTag("selectedHadronsAndPartons","cHadrons"),
    ghostRescaling = cms.double(1e-18),
    hadronFlavourHasPriority = cms.bool(True),
...
process.akCs3PFJets = cms.EDProducer("CSJetProducer",
    ...
    radiusPU = cms.double(0.5),
    rho = cms.InputTag("hiPuRho","mapToRho"),
    rhoFlowFitParams = cms.InputTag("rhoModulationAkCs3PFJets","rhoFlowFitParams"),
    rhom = cms.InputTag("hiPuRho","mapToRhoM"),
    src = cms.InputTag("packedPFCandidates"),
    srcPVs = cms.InputTag(""),
    useDeterministicSeed = cms.bool(True),
...
process.correctedElectrons = cms.EDProducer("CorrectedPatElectronProducer",
    centrality = cms.InputTag("centralityBin","HFtowers"),
    correctionFile = cms.string('HeavyIonsAnalysis/EGMAnalysis/data/SS2023PbPbMC.dat'),
...
process.correctedPatElectronProducer = cms.EDProducer("CorrectedPatElectronProducer",
...
process.hiMuons = cms.EDProducer("HIMuonMVAProducer",
    centrality = cms.InputTag("centralityBin","HFtowers"),
    etaMap = cms.InputTag("hiFJRhoProducerFinerBins","mapEtaEdges"),
...
process.patJetCorrFactorsAK3PFBtag = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
    extraJPTOffset = cms.string('L1FastJet'),
    flavorType = cms.string('J'),
    levels = cms.vstring(
...
process.patJetCorrFactorsAKCs3PF = cms.EDProducer("JetCorrFactorsProducer",
    emf = cms.bool(False),
    extraJPTOffset = cms.string('L1FastJet'),
    flavorType = cms.string('J'),
    levels = cms.vstring(
...
process.patJetFlavourAssociationAKCs3PF = cms.EDProducer("JetFlavourClustering",
    bHadrons = cms.InputTag("patJetPartons","bHadrons"),
    cHadrons = cms.InputTag("patJetPartons","cHadrons"),
    ghostRescaling = cms.double(1e-18),
    hadronFlavourHasPriority = cms.bool(False),
...
process.patJetFlavourAssociationLegacyAKCs3PF = cms.EDProducer("JetFlavourIdentifier",
    physicsDefinition = cms.bool(False),
    srcByReference = cms.InputTag("patJetPartonAssociationLegacyAKCs3PF")
)
...
process.patJetGenJetMatchAKCs3PF = cms.EDProducer("GenJetMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("ak3GenJetsReclusterNoNu"),
    maxDeltaR = cms.double(0.30000000000000004),
    mcPdgId = cms.vint32(),
...
process.patJetPartonAssociationLegacyAKCs3PF = cms.EDProducer("JetPartonMatcher",
    coneSizeToAssociate = cms.double(0.3),
    jets = cms.InputTag("akCs3PFJets"),
    partons = cms.InputTag("allPartons")
)
...
process.patJetPartonMatchAKCs3PF = cms.EDProducer("MCMatcher",
    checkCharge = cms.bool(False),
    matched = cms.InputTag("hiSignalGenParticles"),
    maxDPtRel = cms.double(3.0),
    maxDeltaR = cms.double(0.4),
...
process.patJetsAKCs3PF = cms.EDProducer("PATJetProducer",
    JetFlavourInfoSource = cms.InputTag("patJetFlavourAssociationAKCs3PF"),
    JetPartonMapSource = cms.InputTag("patJetFlavourAssociationLegacyAKCs3PF"),
    addAssociatedTracks = cms.bool(False),
    addBTagInfo = cms.bool(False),
    addDiscriminators = cms.bool(False),
    addEfficiencies = cms.bool(False),
    ...
    embedGenPartonMatch = cms.bool(True),
    embedPFCandidates = cms.bool(True),
    genJetMatch = cms.InputTag("patJetGenJetMatchAKCs3PF"),
    genPartonMatch = cms.InputTag("patJetPartonMatchAKCs3PF"),
    getJetMCFlavour = cms.bool(True),
    jetChargeSource = cms.InputTag(""),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsAKCs3PF")),
    jetIDMap = cms.InputTag("ak4JetID"),
...
process.pfJetProbabilityBJetTagsAK3PFBtag = cms.EDProducer("JetTagProducer",
    jetTagComputer = cms.string('candidateJetProbabilityComputer'),
    tagInfos = cms.VInputTag("pfImpactParameterTagInfosAK3PFBtag")
)
...
process.unsubAK3JetMap = cms.EDProducer("JetMatcherDR",
    ...
    source = cms.InputTag("selectedUpdatedPatJetsAK3PF")
)
...
process.unsubUpdatedPatJetsAK3PF = cms.EDProducer("JetMatcherDR",
    matched = cms.InputTag("patJetsAK3PFUnsubJets"),
    source = cms.InputTag("updatedPatJetsAK3PFBtag")
)
...
process.updatedPatJetsAK3PFBtag = cms.EDProducer("PATJetUpdater",
    addBTagInfo = cms.bool(False),
    addDiscriminators = cms.bool(True),
    addJetCorrFactors = cms.bool(True),
    addTagInfos = cms.bool(False),
    discriminatorSources = cms.VInputTag(),
    jetCorrFactorsSource = cms.VInputTag(cms.InputTag("patJetCorrFactorsAK3PFBtag")),
    jetSource = cms.InputTag("patJetsAKCs3PF"),
    mightGet = cms.optional.untracked.vstring,
    printWarning = cms.bool(True),
    sort = cms.bool(True),
    tagInfoSources = cms.VInputTag(),
...
process.hltfilter = cms.EDFilter("HLTHighLevel",
    HLTPaths = cms.vstring('HLT_HIL2SingleMu7_v3'),
...
process.selectedPatJetsAKCs3PF = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    cutLoose = cms.string(''),
    nLoose = cms.uint32(0),
    src = cms.InputTag("patJetsAKCs3PF")
...
process.selectedUpdatedPatJetsAK3PFBtag = cms.EDFilter("PATJetSelector",
    cut = cms.string(''),
    cutLoose = cms.string(''),
    nLoose = cms.uint32(0),
    src = cms.InputTag("updatedPatJetsAK3PFBtag")
)


process.HiForestInfo = cms.EDAnalyzer("HiForestInfo",
    GlobalTagLabel = cms.string('132X_mcRun3_2023_realistic_HI_v10'),
    HiForestVersion = cms.string(''),
    info = cms.vstring('HiForest, miniAOD, 132X, mc')
)
...
process.akCs3PFJetAnalyzer = cms.EDAnalyzer("HiInclusiveJetAnalyzer",
    ...
    isMC = cms.untracked.bool(True),
    jetAbsEtaMax = cms.untracked.double(2.5),
    jetFlavourInfos = cms.InputTag("ak3PFUnsubJetFlavourInfos"),
    jetName = cms.untracked.string('akCs3PF'),
    jetPtMin = cms.double(15),
    jetTag = cms.InputTag("selectedUpdatedPatJetsAK3PFBtag"),
    matchJets = cms.untracked.bool(True),
...
process.ggHiNtuplizer = cms.EDAnalyzer("ggHiNtuplizer",
    ...
    electronSrc = cms.InputTag("hiElectrons"),
    genParticleSrc = cms.InputTag("packedGenParticles"),
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('132X_mcRun3_2023_realistic_HI_v10'),
...
process.genTask = cms.Task(process.ak2GenJetsReclusterNoNu, process.ak2PFUnsubJetFlavourInfos, process.ak3GenJetsReclusterNoNu, process.ak3PFUnsubJetFlavourInfos, process.allPartons, process.hiSignalGenParticles, process.packedGenParticlesForJetsNoNu, process.selectedHadronsAndPartons)


process.patAlgosToolsTask = cms.Task(process.PackedPFTowers, process.ak2PFUnsubJets, process.ak3PFUnsubJets, process.akCs2PFJets, process.akCs3PFJets, process.hiPuRho, process.patJetCorrFactorsAK2PFBtag, process.patJetCorrFactorsAK2PFUnsubJets, process.patJetCorrFactorsAK3PFBtag, process.patJetCorrFactorsAK3PFUnsubJets, process.patJetCorrFactorsAKCs2PF, process.patJetCorrFactorsAKCs3PF, process.patJetFlavourAssociationAK2PFUnsubJets, process.patJetFlavourAssociationAK3PFUnsubJets, process.patJetFlavourAssociationAKCs2PF, process.patJetFlavourAssociationAKCs3PF, process.patJetFlavourAssociationLegacyAK2PFUnsubJets, process.patJetFlavourAssociationLegacyAK3PFUnsubJets, process.patJetFlavourAssociationLegacyAKCs2PF, process.patJetFlavourAssociationLegacyAKCs3PF, process.patJetGenJetMatchAK2PFUnsubJets, process.patJetGenJetMatchAK3PFUnsubJets, process.patJetGenJetMatchAKCs2PF, process.patJetGenJetMatchAKCs3PF, process.patJetPartonAssociationLegacyAK2PFUnsubJets, process.patJetPartonAssociationLegacyAK3PFUnsubJets, process.patJetPartonAssociationLegacyAKCs2PF, process.patJetPartonAssociationLegacyAKCs3PF, process.patJetPartonMatchAK2PFUnsubJets, process.patJetPartonMatchAK3PFUnsubJets, process.patJetPartonMatchAKCs2PF, process.patJetPartonMatchAKCs3PF, process.patJetPartons, process.patJetPartonsLegacy, process.patJetPartonsLegacyUnsubJets, process.patJetPartonsUnsubJets, process.patJetsAK2PFUnsubJets, process.patJetsAK3PFUnsubJets, process.patJetsAKCs2PF, process.patJetsAKCs3PF, process.selectedPatJetsAK2PFUnsubJets, process.selectedPatJetsAK3PFUnsubJets, process.selectedPatJetsAKCs2PF, process.selectedPatJetsAKCs3PF, process.selectedUpdatedPatJetsAK2PFBtag, process.selectedUpdatedPatJetsAK3PFBtag, process.unsubAK2JetMap, process.unsubAK3JetMap, process.unsubUpdatedPatJetsAK2PF, process.unsubUpdatedPatJetsAK3PF, process.updatedPatJetsAK2PFBtag, process.updatedPatJetsAK3PFBtag)
...
process.forest = cms.Path(process.zMMSkimSequence+process.HiForestInfo+process.centralityBin+process.hltanalysis+process.trackSequencePbPb+process.hiEvtAnalyzer+process.HiGenParticleAna+process.muonSequence+process.rhoSequence+process.metFilters+process.muonAnalyzer+process.akCs2PFJetAnalyzer+process.akCs3PFJetAnalyzer, process.genTask, process.patAlgosToolsTask)
