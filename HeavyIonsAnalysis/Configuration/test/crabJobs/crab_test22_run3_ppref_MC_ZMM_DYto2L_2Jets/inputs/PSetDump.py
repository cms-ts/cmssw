...
process.genTask = cms.Task(process.ak2GenJetsReclusterNoNu, process.ak2PFFlavourInfos, process.allPartons, process.hiSignalGenParticles, process.packedGenParticlesForJetsNoNu, process.selectedHadronsAndPartons)


process.patAlgosToolsTask = cms.Task(process.ak2PFJetsCHS, process.ak2PFUnsubJets, process.patJetCorrFactorsAK2PFCHS, process.patJetCorrFactorsAK2PFCHSBtag, process.patJetCorrFactorsAK2PFUnsubJets, process.patJetFlavourAssociationAK2PFCHS, process.patJetFlavourAssociationAK2PFUnsubJets, process.patJetFlavourAssociationLegacyAK2PFCHS, process.patJetFlavourAssociationLegacyAK2PFUnsubJets, process.patJetGenJetMatchAK2PFCHS, process.patJetGenJetMatchAK2PFUnsubJets, process.patJetPartonAssociationLegacyAK2PFCHS, process.patJetPartonAssociationLegacyAK2PFUnsubJets, process.patJetPartonMatchAK2PFCHS, process.patJetPartonMatchAK2PFUnsubJets, process.patJetPartons, process.patJetPartonsLegacy, process.patJetPartonsLegacyUnsubJets, process.patJetPartonsUnsubJets, process.patJetsAK2PFCHS, process.patJetsAK2PFUnsubJets, process.pfCHS, process.selectedPatJetsAK2PFCHS, process.selectedPatJetsAK2PFUnsubJets, process.selectedUpdatedPatJetsAK2PFCHSBtag, process.unsubAK2JetMap, process.unsubUpdatedPatJetsAK2PFCHS, process.updatedPatJetsAK2PFCHSBtag)
...
process.forest = cms.Path(process.HiForestInfo+process.hltanalysis+process.hiEvtAnalyzer+process.HiGenParticleAna+process.trackSequencePP+process.rhoSequence+process.unpackedMuons+process.muonAnalyzer+process.metFilters+process.ak2PFJetAnalyzer, process.genTask, process.patAlgosToolsTask)
