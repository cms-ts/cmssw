...
config.General.requestName = 'test24_data_MinBias'

config.JobType.pluginName = 'Analysis'
# Name of the CMSSW configuration file
config.JobType.psetName = 'forest_miniAOD_run3_DATA_MinBias.py'
...
config.Data.outputDatasetTag = 'CRAB3_Analysis_test24_data_MinBias'
