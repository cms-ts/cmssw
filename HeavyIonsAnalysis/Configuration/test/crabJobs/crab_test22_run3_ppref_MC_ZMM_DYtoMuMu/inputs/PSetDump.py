...
process.forest = cms.Path(process.HiForestInfo+process.hltanalysis+process.hiEvtAnalyzer+process.HiGenParticleAna+process.trackSequencePP+process.unpackedMuons+process.muonAnalyzer+process.rhoSequence+process.metFilters+process.ak2PFJetAnalyzer, process.genTask, process.patAlgosToolsTask)
