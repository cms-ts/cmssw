...
process.forest = cms.Path(process.zMMSkimSequence+process.HiForestInfo+process.centralityBin+process.hiEvtAnalyzer+process.hltanalysis+process.trackSequencePbPb+process.unpackedMuons+process.muonAnalyzer+process.rhoSequence+process.metFilters+process.akCs2PFJetAnalyzer, process.patAlgosToolsTask)
